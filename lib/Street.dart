...
class _StreetState extends State<Street> with TickerProviderStateMixin {

  final ButtonStyle raisedButtonStyle = ElevatedButton.styleFrom(
    onPrimary: Colors.white,
    primary: Colors.red.shade900.withOpacity(0.9),
                          ...
                          children: [
                            Container(
                              ...
                              child: ElevatedButton(onPressed: () {
                                ...
                                child: Icon(Icons.arrow_back_ios,color: Colors.redAccent.shade700,size: 30,),),
                            )
                          ],
                        ),
                        decoration:BoxDecoration(
