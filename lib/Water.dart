...
class _WaterState extends State<Water> with TickerProviderStateMixin {

  final ButtonStyle raisedButtonStyle = ElevatedButton.styleFrom(
    onPrimary: Colors.white,
    primary: Colors.purple.shade900.withOpacity(0.9),
                          ...
                          children: [
                            Container(
                              ...
                              child: ElevatedButton(onPressed: () {
                                ...
                                child: Icon(Icons.arrow_back_ios,color: Colors.purpleAccent.shade700,size: 30,),),
                            )
                          ],
                        ),
                        decoration:BoxDecoration(
